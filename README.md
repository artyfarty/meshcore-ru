...
### Дефолты для московского мешкора
В `arduino_base` прописаны параметры радио: `FREQ=868.731018`, `BW=62.5`, `SF=7`, `CR=7`. Применяются при первом включении (до конфигурации через клиент).
